...
"sq") ./build/tests/unit_test --log_level=test_suite --run_test=eosdos_tests/sell_quote_tests -- --verbose ;;
"tsq") ./build/tests/unit_test --log_level=test_suite --run_test=eosdos_tests/sell_quote_testparam_formula_tests* -- --verbose ;;
