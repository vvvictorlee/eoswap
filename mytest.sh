...
"wi") ./build/tests/unit_test --log_level=test_suite --run_test=eosdos_tests/withdraw_quote_testparam_formula_tests -- --verbose ;;
"tf") ./build/tests/unit_test --log_level=test_suite --run_test=eosdos_tests/transfer_fee_tests -- --verbose ;;
"sq") ./build/tests/unit_test --log_level=test_suite --run_test=eosdos_tests/sell_quote_testparam_formula_tests -- --verbose ;;
"tsq") ./build/tests/unit_test --log_level=test_suite --run_test=eosdos_tests/buybase_sellquote_testparam_formula_tests -- --verbose ;;
"se") ./build/tests/unit_test --log_level=test_suite --run_test=eosdos_tests/buybase_sellquote_testparam_formula_tests -- --verbose ;;
