...
pub use self::sub_art_tradable::{SubArtTradable, SubArtTradableRef};
...
pub mod sub_art_tradable {
    ...
    impl super::Erc1155 for SubArtTradable {
        #[ink(message)]
        fn safe_transfer_from(
            &mut self,
            from: AccountId,
    ...
    impl super::Erc1155TokenReceiver for SubArtTradable {
        #[ink(message, selector = 0xF23A6E61)]
        fn on_received(
            &mut self,
            _operator: AccountId,
    ...
    mod tests {
        ...
        type Event = <SubArtTradable as ::ink_lang::reflect::ContractEventBase>::Type;
        ...
        fn assert_transfer_single_event(
            ...
            let expected_topics = vec![
                encoded_into_hash(&PrefixedValue {
                    value: b"SubArtTradable::TransferSingle",
                    prefix: b"",
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"SubArtTradable::TransferSingle::operator",
                    value: &expected_operator,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"SubArtTradable::TransferSingle::from",
                    value: &expected_from,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"SubArtTradable::TransferSingle::to",
                    value: &expected_to,
                }),
            ];
        ...
        fn assert_transfer_batch_event(
            ...
            let expected_topics = vec![
                encoded_into_hash(&PrefixedValue {
                    value: b"SubArtTradable::TransferBatch",
                    prefix: b"",
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"SubArtTradable::TransferBatch::operator",
                    value: &expected_operator,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"SubArtTradable::TransferBatch::from",
                    value: &expected_from,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"SubArtTradable::TransferBatch::to",
                    value: &expected_to,
                }),
            ];
