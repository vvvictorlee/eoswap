...
//!
//! This is an Art Factory implementation.
//!
...
mod sub_art_factory {
    ...
    pub struct SubArtFactory {
        ...
        /// NFT Art Tradable  contract code hash
        code_hash: Hash,
        ///  The contract owner
        owner: AccountId,
    ...
    impl SubArtFactory {
        /// Creates a new SubArtFactorycontract.
        #[ink(constructor)]
        pub fn new(
            marketplace: AccountId,
            bundle_marketplace: AccountId,
        ...
        pub fn create_nft_contract(&mut self, name: String, symbol: String) -> Result<AccountId> {
            ...
            let instantiate_contract = || -> Result<AccountId> {
                ...
                #[cfg(not(test))]
                {
                    ...
                    let contract_addr =
                        init_result.expect("failed at instantiating the `art tradable` contract");
        ...
        ///  Method for disabling existing SubArtTradable contract
        /// # Fields
        ///   token_contract Address of NFT contract
        ///
        /// # Errors
    ...
    mod tests {
        ...
        fn init_contract() -> SubArtFactory {
            let erc = SubArtFactory::new(
                frank(),
                eve(),
                1,
                10,
