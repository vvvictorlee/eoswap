//! #  NFT Tradable Private
//!
//! This is an ERC-721 Token compatible implementation.
//!
//! ## Warning
//!
...
pub use self::sub_nft_tradable_private::{SubNFTTradablePrivate, SubNFTTradablePrivateRef};
...
#[ink::contract]
pub mod sub_nft_tradable_private {
    ...
    pub struct SubNFTTradablePrivate {
    ...
    impl SubNFTTradablePrivate {
        /// Creates a new Sub NFT Tradable Private contract.
        /// # Fields
        /// name token name
        /// symbol token symbol
    ...
    impl Erc721 for SubNFTTradablePrivate {
        /// Returns the balance of the owner.
        ///
        /// This represents the amount of unique tokens the owner has.
        #[ink(message)]
    ...
    mod tests {
        ...
        #[ink::test]
        fn mint_nft_failed_if_the_caller_is_not_the_owner_of_the_contract() {
            // Create a new contract instance.
            let mut nft_tradable = init_contract();
            let caller = eve();
            set_caller(caller);
