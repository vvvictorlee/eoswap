...
pub mod sub_nft_factory_private {
    ...
    pub struct SubNFTFactoryPrivate {
        //// Auction contract
        auction: AccountId,
    ...
    impl SubNFTFactoryPrivate {
        /// Creates a new SubNFTFactoryPrivate contract.
        #[ink(constructor)]
        pub fn new(
            auction: AccountId,
            marketplace: AccountId,
        ...
        ///  Method for deploying new SubNFTTradablePrivate contract
        /// # Fields
        ...
        ///  Method for registering existing SubNFTTradablerPrivate contract
        /// # Fields
    ...
    mod tests {
        ...
        fn init_contract() -> SubNFTFactoryPrivate {
            let erc = SubNFTFactoryPrivate::new(
                django(),
                eve(),
                frank(),
                1,
