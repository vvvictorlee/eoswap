...
const nftFactory = require("../abi/sub_auction_v0.1.json");
...
const nftTradableAddress = getTokenAddress("nftTradable", 0);
...
beforeAll(async () => {
    ...
    // await api.isReady;
    // let abi = new Abi(nftFactory, api.registry.getChainProperties());
...
describe("nftFactory", () => {
    ...
    test("createNftContract", async () => {
        ...
        await signedTxC("nftFactory", "createNftContract", ["test", "TEST"], null, null, null)
        await queryC("nftFactory", "tokens", [], null)
    ...
    test("disableTokenContract", async () => {
        setCaller(alicePair)
        await signedTxC("nftFactory", "disableTokenContract", [nftTradableAddress], null, null, null)
        const a = await queryC("nftFactory", "exists", [nftTradableAddress], null)
        console.warn("========nftFactory list item=======", a)
    ...
    test("registerTokenContract", async () => {
        ...
        await signedTxC("nftFactory", "registerTokenContract", [nftTradableAddress], null, null, null)
        const a = await queryC("nftFactory", "exists", [nftTradableAddress], null)
        console.warn("========nftFactory list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateBundleMarketplace", async () => {
        ...
        await signedTxC("nftFactory", "updateBundleMarketplace", [bundleMarketplaceAddress], null, null, null)
        const a = await queryC("nftFactory", "bundleMarketplace", [], null)
        console.warn("========nftFactory list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateMarketplace", async () => {
        ...
        await signedTxC("nftFactory", "updateMarketplace", [marketplaceAddress], null, null, null)
        const a = await queryC("nftFactory", "marketplace", [], null)
        console.warn("========nftFactory list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateEndowmentAmount", async () => {
        ...
        await signedTxC("nftFactory", "updateEndowmentAmount", [10], null, null, null)
        const a = await queryC("nftFactory", "endowmentAmount", [], null)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateMintFee", async () => {
        ...
        await signedTxC("nftFactory", "updateMintFee", [10], null, null, null)
        const a = await queryC("nftFactory", "platformFee", [], null)
        console.warn("========nftFactory list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updatePlatformFee", async () => {
        ...
        await signedTxC("nftFactory", "updatePlatformFee", [10], null, null, null)
        const a = await queryC("nftFactory", "platformFee", [], null)
        console.warn("========nftFactory list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updatePlatformFeeRecipient", async () => {
        setCaller(alicePair)
        await signedTxC("nftFactory", "updatePlatformFeeRecipient", [BOB], null, null, null)
        const a = await queryC("nftFactory", "feeRecipient", [], null)
        console.warn("========nftFactory list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
