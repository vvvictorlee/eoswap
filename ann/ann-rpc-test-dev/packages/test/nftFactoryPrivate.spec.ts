...
const nftFactoryPrivate = require("../abi/sub_auction_v0.1.json");
...
const nftTradablePrivateAddress = getTokenAddress("nftTradablePrivate", 0);
...
beforeAll(async () => {
    ...
    // await api.isReady;
    // let abi = new Abi(nftFactoryPrivate, api.registry.getChainProperties());
...
describe("nftFactoryPrivate", () => {
    beforeAll((): void => {
    });
    test("createNftContract", async () => {
        const nftFactoryPrivateAddress = getContractAddress("nftFactoryPrivate");
        await signedTxC("nftFactoryPrivate", "createNftContract", ["test", "TEST"], null, null, null)
        await queryC("nftFactoryPrivate", "tokens", [], null)
    ...
    test("disableTokenContract", async () => {
        setCaller(alicePair)
        await signedTxC("nftFactoryPrivate", "disableTokenContract", [nftTradablePrivateAddress], null, null, null)
        const a = await queryC("nftFactoryPrivate", "exists", [nftTradablePrivateAddress], null)
        console.warn("========nftFactoryPrivate list item=======", a)
    ...
    test("registerTokenContract", async () => {
        ...
        await signedTxC("nftFactoryPrivate", "registerTokenContract", [nftTradablePrivateAddress], null, null, null)
        const a = await queryC("nftFactoryPrivate", "exists", [nftTradablePrivateAddress], null)
        console.warn("========nftFactoryPrivate list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateBundleMarketplace", async () => {
        ...
        await signedTxC("nftFactoryPrivate", "updateBundleMarketplace", [bundleMarketplaceAddress], null, null, null)
        const a = await queryC("nftFactoryPrivate", "bundleMarketplace", [], null)
        console.warn("========nftFactoryPrivate list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateMarketplace", async () => {
        ...
        await signedTxC("nftFactoryPrivate", "updateMarketplace", [marketplaceAddress], null, null, null)
        const a = await queryC("nftFactoryPrivate", "marketplace", [], null)
        console.warn("========nftFactoryPrivate list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateEndowmentAmount", async () => {
        ...
        await signedTxC("nftFactoryPrivate", "updateEndowmentAmount", [10], null, null, null)
        const a = await queryC("nftFactoryPrivate", "endowmentAmount", [], null)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updateMintFee", async () => {
        ...
        await signedTxC("nftFactoryPrivate", "updateMintFee", [10], null, null, null)
        const a = await queryC("nftFactoryPrivate", "platformFee", [], null)
        console.warn("========nftFactoryPrivate list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updatePlatformFee", async () => {
        ...
        await signedTxC("nftFactoryPrivate", "updatePlatformFee", [10], null, null, null)
        const a = await queryC("nftFactoryPrivate", "platformFee", [], null)
        console.warn("========nftFactoryPrivate list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
    ...
    test("updatePlatformFeeRecipient", async () => {
        setCaller(alicePair)
        await signedTxC("nftFactoryPrivate", "updatePlatformFeeRecipient", [BOB], null, null, null)
        const a = await queryC("nftFactoryPrivate", "feeRecipient", [], null)
        console.warn("========nftFactoryPrivate list item=======", a)
        expect(global.console.error).toHaveBeenCalledWith('log');
