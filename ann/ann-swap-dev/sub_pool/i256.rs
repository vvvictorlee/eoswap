...
use crate::primitives::WrapperU256;
use core::{
    cmp,
...
#[derive(Clone, Copy, Default, Hash, Decode, Encode, Eq, PartialEq)]
#[cfg_attr(feature = "std", derive(scale_info::TypeInfo,))]
pub struct I256(U256);
impl SpreadLayout for I256 {
...
impl PackedAllocate for I256 {
    fn allocate_packed(&mut self, at: &Key) {
        PackedAllocate::allocate_packed(&mut self.into_raw().0, at);
    }
}
...
impl I256 {
    ...
    pub fn from_dec_str(value: &str) -> Result<Self, ParseI256Error> {
        ...
        let abs = U256::from_dec_str(value).unwrap();
        let result = I256::checked_from_sign_and_abs(sign, abs)
            .ok_or(ParseI256Error::IntegerOverflow)
            .unwrap();
...
impl From<WrapperU256> for I256 {
    fn from(n: WrapperU256) -> Self {
        Self(n.value)
    }
}
...
impl fmt::UpperHex for I256 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        let mut buffer = ink_prelude::format!("{:x}", abs);
