...
struct [[eosio::table("dodo"), eosio::contract("eodos")]] DODOStorage {
...
struct [[eosio::table("proxy"), eosio::contract("eodos")]] ProxyStorage {
   DODOEthProxyStore proxy;
   ReentrancyGuardStore guard;
  
   EOSLIB_SERIALIZE(
       ProxyStorage, (proxy)(guard))
};
...
struct [[eosio::table("zoo"), eosio::contract("eodos")]] ZooStorage {
   ...
   EOSLIB_SERIALIZE(
       ZooStorage, (ownable)(_DODO_LOGIC_)(_CLONE_FACTORY_)(_DEFAULT_SUPERVISOR_)(_DODO_REGISTER_)(_DODOs))
};
