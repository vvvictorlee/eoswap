...
struct DODOStore {
   ...
   uint64_t _GAS_PRICE_LIMIT_;

   // ============ Advanced Controls ============
   bool    _BUYING_ALLOWED_;
   bool    _SELLING_ALLOWED_;
   uint64_t _BASE_BALANCE_LIMIT_;
   uint64_t _QUOTE_BALANCE_LIMIT_;
   ...
   uint64_t                 _BASE_CAPITAL_RECEIVE_QUOTE_;
   uint64_t                 _QUOTE_CAPITAL_RECEIVE_BASE_;
   ...
   EOSLIB_SERIALIZE(
       ...
       (dodo_name)(initownable)(guard)(_INITIALIZED_)(_CLOSED_)(_DEPOSIT_QUOTE_ALLOWED_)(_DEPOSIT_BASE_ALLOWED_)(
           ...
           _QUOTE_BALANCE_)(_BASE_CAPITAL_TOKEN_)(_QUOTE_CAPITAL_TOKEN_)(_BASE_CAPITAL_RECEIVE_QUOTE_)(
           _QUOTE_CAPITAL_RECEIVE_BASE_)(_CLAIMED_))
};
